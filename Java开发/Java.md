...
![IO_cnajssas](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/IO_cnajssas.png)
...
![thread_nvdknj](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/thread_nvdknj.png)
...
![thread_dsavdfg](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/thread_dsavdfg.png)
...
![thread_ankvsn](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/thread_ankvsn.png)

![thread_ahrejni](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/thread_ahrejni.png)
...
![threadpool_ionvca](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/threadpool_ionvca.png)
...
>
> ![cpu_cache_njkcnad](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/cpu_cache_njkcnad.png)
>
...
![jvm_cmskaf](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/jvm_cmskaf.jpg)
...
![jmm_cnsknv](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/jmm_cnsknv.png)
...
![happens_before_sanjkvds](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/happens_before_sanjkvds.png)
...
![AQS_ivnsdjo](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/AQS_ivnsdjo.png)
...
![AQS_onvoab](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/AQS_onvoab.png)
...
![AQS_ocbnas](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/AQS_ocbnas.png)
...
- 对于volatile变量的写操作，JVM会在写操作前插入StoreStore屏障，使得本次写操作之前的所有写操作执行完才会执行本次写操作，保证前面的所有写操作对本次写操作的可见性；在写操作后插入StoreLoad屏障，使得本次写操作执行完才会执行之后的读操作，保证本次写操作对于后面的读操作的可见性。
  ...
  ![volatile_mclnv](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/volatile_mclnv.jpg)

- 对于volatile变量的读操作，JVM会在读操作后插入LoadLoad屏障，使得本次读操作执行完才能只能后续的读操作，保证本次读操作对后续读操作的可见性；在读操作之后插入LoadStore屏障，保证在此次读操作执行完才能进行之后的写操作。

  ![volatile_asnjc](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/volatile_asnjc.jpg)
...
- 如果引入 volatile，我们再看一下代码：
  ...
  ![volatile_onacncsa](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/volatile_onacncsa.jpg)
...
![synchronized_monitor_pnckas](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_monitor_pnckas.png)

![synchronized_monitor_xpsca](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_monitor_xpsca.png)
...
![synchronized_lock_lnjsboa](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_lock_lnjsboa.png)
...
![synchronized_lock_kasjbc](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_lock_kasjbc.png)
...
![synchronized_lock_lanoibf](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_lock_lanoibf.png)
...
- 处于偏向锁时，遇到两个及以上的线程竞争，此时从偏向锁升级为轻量级锁。
  ...
  ![synchronized_lock_noasb](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_lock_noasb.jpeg)

  ![synchronized_lock_aohwd](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/synchronized_lock_aohwd.jpeg)
...
![AQS_omvdjsn](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/AQS_omvdjsn.png)
...
![ReentrantLock_opqnd](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/ReentrantLock_opqnd.png)
...
![ReentrantLock_onxsan](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/ReentrantLock_onxsan.png)
...
![jmm_dsadvnk](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/jmm_dsadvnk.png)
...
![jvm_csanio](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/jvm_csanio.jpg)
...
![jvm_snckas](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/jvm_snckas.webp)
...
![object_memory_xnldlk](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/object_memory_xnldlk.png)
...
![object_memory_papfq](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/object_memory_papfq.png)

先简单介绍下对象头的形式，JVM中对象头的方式有以下两种（以32位JVM为例）：

普通对象：

![object_memory_apqnp](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/object_memory_apqnp.png)

数组对象：

![object_memory_nconajp](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/object_memory_nconajp.png)

##### 1.7.1.1 Mark Word
这部分主要用来存储对象自身的运行时数据，如hashcode、gc分代年龄等。mark word的位长度为JVM的一个Word大小，也就是说32位JVM的Mark word为32位，64位JVM为64位。
为了让一个字大小存储更多的信息，JVM将字的最低两个位设置为标记位，不同标记位下的Mark Word示意如下：

![object_memory_zmpbng](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/object_memory_zmpbng.png)

其中各部分的含义如下：

- lock：2位的锁状态标记位，由于希望用尽可能少的二进制位表示尽可能多的信息，所以设置了lock标记。该标记的值不同，整个mark word表示的含义不同。

![object_memory_mvjso](https://raw.githubusercontent.com/Hojay-Chen/development-note-resource/main/images/object_memory_mvjso.png)
