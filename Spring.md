  ...
  ### 3.2 Spring IoC容器和容器实现
    ...
    - **3.2.1 普通和复杂容器**
      ...
      **普通容器**
        ...
        ![](https://secure2.wostatic.cn/static/t65AXJYvxmQdZB9qcKKy2H/img002.png?auth_key=1744896916-jGuEGoYfKvCCortoUJDwLX-0-b1d573a2835a2224fd634ac923bef382)
...
```
          2. xml配置文件编写
              ...
              ![](https://secure2.wostatic.cn/static/7eC1WeTyXz1oLaGkPfJBfh/image.png?auth_key=1744896330-e1kNqsh9aeLs9PhTdFPsL-0-ec206f3d8997ec9c51a7d00f0fe6efd8)
...
```
    ...
    #### 4.4.6 实验五：基于注解+配置类方式整合三层架构组件
      1. 需求分析
          ...
          ![](https://secure2.wostatic.cn/static/spSLnBnMYbqJXYLqjr2C7y/image.png?auth_key=1744896944-jmCWjrSmonFuwv5Qwy4gYy-0-62a18553a0140003a4506a3b14315bc3)
      2. 数据库准备
...
```
    4. 声明带日志接口实现
        ...
        ![](https://secure2.wostatic.cn/static/rP27XVMnTD1FtCx1maiUuW/aopimg002.png?auth_key=1744896956-7MFFMvtjjVLCmLzstSxmH5-0-7c91b71f38e9bc60fd9621bd372052b4)
...
```
  ...
  ### 5.2 解决技术代理模式
    1. **代理模式**
        ...
        ![](https://secure2.wostatic.cn/static/2KdCVRG7sTJfhNGH3QaB58/aopimg004.png?auth_key=1744896959-6kRyURAsDju9SRrJPnrxiZ-0-9ac181d58d15d3d3a816248fb012ae30)
    
        有代理场景：
    
        ![](https://secure2.wostatic.cn/static/atPYpsBfyndTrgArisWrag/aopimg005.png?auth_key=1744896959-9EnFuWg3PPwDuJTUc9Pamf-0-d1f43ba78b490b68b2c1ee87960e93e0)
...
```
    ...
    3. **动态代理**
        ...
        JDK动态代理技术实现（了解）
          ...
          ![](https://secure2.wostatic.cn/static/23QMoxyYUoz7qSJeAnRUug/aopimg003.png?auth_key=1744896959-nrs6PwQT4ULUvfqhkVfm63-0-0c47d97d7b7f24a8aae37b278934f9f1)
...
```
  ...
  ### 5.3 面向切面编程思维（AOP）
    1. **面向切面编程思想AOP**
        ...
        ![](https://secure2.wostatic.cn/static/7xBHASmuNUSNpC3bZmWUHT/image.png?auth_key=1744896958-pqmKoqMC7EnZLNZdy3aYCz-0-546abb5479483655d73b149e0bd7235f)
    
        AOP技术恰恰相反，它利用一种称为"横切"的技术，剖解开封装的对象内部，并将那些影响了多个类的公共行为封装到一个可重用模块，并将其命名为"Aspect"，即切面。所谓"切面"，简单说就是那些与业务无关，却为业务模块所共同调用的逻辑或责任封装起来，便于减少系统的重复代码，降低模块之间的耦合度，并有利于未来的可操作性和可维护性。
    
        使用AOP，可以在不修改原来代码的基础上添加新功能。
    
        ![](https://secure2.wostatic.cn/static/pSbvngwba8MqmH69aQfzjj/image.png?auth_key=1744896957-v4gEtuvTWbmLHpoxM6BoUL-0-cf8d9eba6dc8a766db0dfa9a07d3c2cd)
    2. **AOP思想主要的应用场景**
    ...
    3. **AOP术语名词介绍**
        ...
        ![](https://secure2.wostatic.cn/static/q1FA8t8MXYLLqk6gybZ5Ya/aopimg007.png?auth_key=1744896957-71fSrtKDUpdfT74yVgdMVF-0-c6b1fdf15e3dada65862acba6ad61a95)
        ...
        ![](https://secure2.wostatic.cn/static/p2kNLy4hrpYoHRjpanrS2t/aopimg008.png?auth_key=1744896957-kuj6cFEcbsTDXcikYafjLs-0-697b096f9bef1d45e09702824a5dcd89)
        ...
        ![](https://secure2.wostatic.cn/static/ssFYqSKwRkku7yWm1KrHFo/apoimg010.png?auth_key=1744896958-38hYsYc524mWCATtNKwwv1-0-d6275742869278fd4e62c08bebb187c1)
        ...
        ![](https://secure2.wostatic.cn/static/8Y4kgKdeMeNz2RSFkHo4o1/aopimg009.png?auth_key=1744896957-eL3BxcW2XAzhkx4SBVbQmF-0-76af86a223e2e85dc1f0782648544ecc)
  ...
  ### 5.5 Spring AOP基于注解方式实现和细节
    ...
    #### 5.5.1 Spring AOP底层技术组成
      ...
      ![](https://secure2.wostatic.cn/static/pRzPnt5i7zeasX3V3zYZQ4/aopimg006-1716953659294.png?auth_key=1744896962-fEaLHEYX17BVCj8rfighny-0-c6f05e5247e9c9b3d6321cbfaabdd5af)
...
```
    ...
    #### 5.5.4 切点表达式语法
      1. **切点表达式作用**
          ...
          ![](https://secure2.wostatic.cn/static/bYuoZYrB1bTE9phRx5AJfk/apoimg028.png?auth_key=1744896965-K4egUScLchToa6MPXvsaQ-0-8ee420b99a378832e140f2739418852b)
      2. **切点表达式语法**
    
          切点表达式总结
    
          ![](https://secure2.wostatic.cn/static/u3zGFYMEQBEc9aXovEQo1R/apoimg011.png?auth_key=1744896965-rRziBKyK8rAzHTBkKVncFz-0-69e52187eb49285fbc38a7254a6876cd)
...
```
    ...
    #### 5.5.7 切面优先级设置
      ...
      ![](https://secure2.wostatic.cn/static/iEnKQ8R7ApCSeaF4x3wuYa/aopimg012.png?auth_key=1744896969-xh2i4yoEHvk9LYpBV1upmA-0-7caacf5214ed4a5cc5534cb5873d67fc)
    
      实际意义
    
      实际开发时，如果有多个切面嵌套的情况，要慎重考虑。例如：如果事务切面优先级高，那么在缓存中命中数据的情况下，事务切面的操作都浪费了。
    
      ![](https://secure2.wostatic.cn/static/6g2Cj5L8KRRnnaZ3zRReu/aopimg013.png?auth_key=1744896969-kFTqakeHHyh9GzuKN27ct6-0-9b7dbfca5420052b933bb993a73377c7)
...
```
      ...
      ![](https://secure2.wostatic.cn/static/wDFPhenVxhRjSLAYxZxe66/img029.png?auth_key=1744896970-6viyDfYfqZSunYdPm5jtZo-0-94e2e3a0cd3812509946ed49ba49451f)
    
      有接口：
    
      ![](https://secure2.wostatic.cn/static/9GdskQzE3TDD2FnqUTLQJU/img030.png?auth_key=1744896970-9ksoh5M7zFSEW6W89cBaTQ-0-3886669796f71cee4ebd82706d3b7c9b)
    ...
    #### 5.5.9 注解实现小结
      ...
      ![](https://secure2.wostatic.cn/static/sfHfbbULBw5jTj8dnzEnKT/aopimg015.png?auth_key=1744896970-ed9QiQZyp6KqXZ7Zt53ZUf-0-f7f5f4d5c4b0225277d2f412cd333273)
...
```
  ...
  ### 5.7 Spring AOP对获取Bean的影响理解
    ...
    #### 5.7.2 使用总结
      ...
      ![](https://secure2.wostatic.cn/static/dJxjyGJAQazCzzNRQCyPMb/image.png?auth_key=1744896973-aUbvEJb88y9sPFeFSLvMt-0-95800d01e83f33e64654b54fa0c38121)
    
      对没实现接口的类应用切面new
    
      ![](https://secure2.wostatic.cn/static/mRgDnd1d6a3oa73t2A7LDK/image.png?auth_key=1744896973-fP2CA2itbVAtc1bRvFKzRN-0-2d1b111554aeb52a849455e079e57687)
...
```
    ...
    #### 6.1.3 Spring事务管理器
      ...
      2. Spring声明式事务对应事务管理器接口
          ...
          ![](https://secure2.wostatic.cn/static/cTpSy6E9Vzq4H8i1x7MLEf/image.png?auth_key=1744896974-swK3xiCqdFfD5VEZ8HxRN-0-cdecaed12495485e06c630fbd5c86f96)
...
```
    ...
    #### 6.2.7 事务属性：事务传播行为
      1. 事务传播行为要研究的问题
          ...
          ![](https://secure2.wostatic.cn/static/t9aMhzWSt1v8HnQy7Uaoui/img012.png?auth_key=1744896981-tq4o9CUCZ4PH7pnPWgW2sk-0-7f166633c859599423dad38aa1a70533)
